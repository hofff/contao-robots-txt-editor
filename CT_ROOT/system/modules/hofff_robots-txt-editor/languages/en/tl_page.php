...
$GLOBALS['TL_LANG']['tl_page']['useDomainSpecificRobotsTxt_htaccessInstalled']    = array("Use domain specific robots.txt", "Please select, if the robots.txt should be domain specific, i.e. for the domain of this page tree a custom robots.txt will be created in the <i>share</i> folder and in the .htaccess file a corresponding rewrite rule is added.");
